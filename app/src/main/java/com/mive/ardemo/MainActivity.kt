...
class MainActivity : AppCompatActivity() {
    ...
    // Check if we currently tracking an object in a view
    private var isTracking: Boolean = false

    // Checks if our AR app hits an object
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        floatingActionButton.setOnClickListener { addObject(Uri.parse("USSEnterprise.sfb")) }
        showFab(false)
